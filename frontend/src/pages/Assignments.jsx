...
export default function Assignments() {
    ...
    const fetchTrainerBatches = async () => {
        try {
            const res = await fetch(`${(window.location.hostname === 'localhost' || window.location.hostname === '127.0.0.1' ? 'http://127.0.0.1:8000/api' : 'https://kravia.onrender.com/api')}/trainer/my-courses/?email=${user.email}`);
            if (res.ok) {
    ...
    const fetchAllBatches = async () => {
        try {
            const res = await fetch(`${(window.location.hostname === 'localhost' || window.location.hostname === '127.0.0.1' ? 'http://127.0.0.1:8000/api' : 'https://kravia.onrender.com/api')}/list-courses/`);
            if (res.ok) {
                const data = await res.json();
    ...
    const fetchAssignments = async () => {
        try {
            const res = await fetch(`${(window.location.hostname === 'localhost' || window.location.hostname === '127.0.0.1' ? 'http://127.0.0.1:8000/api' : 'https://kravia.onrender.com/api')}/assignments/?email=${user.email}`);
            if (res.ok) {
                const data = await res.json();
                setAssignments(data);
            }
    ...
    const fetchSubmissions = async (assignmentId) => {
        try {
            const res = await fetch(`${(window.location.hostname === 'localhost' || window.location.hostname === '127.0.0.1' ? 'http://127.0.0.1:8000/api' : 'https://kravia.onrender.com/api')}/assignments/${assignmentId}/submissions/?email=${user.email}`);
            if (res.ok) {
                const data = await res.json();
                setSubmissions(data);
            }
    ...
    const handleCreateAssignment = async (e) => {
        ...
        try {
            const res = await fetch(`${(window.location.hostname === 'localhost' || window.location.hostname === '127.0.0.1' ? 'http://127.0.0.1:8000/api' : 'https://kravia.onrender.com/api')}/assignments/`, {
                method: 'POST',
    ...
    const handleEditAssignment = async (e) => {
        ...
        try {
            const res = await fetch(`${(window.location.hostname === 'localhost' || window.location.hostname === '127.0.0.1' ? 'http://127.0.0.1:8000/api' : 'https://kravia.onrender.com/api')}/assignments/${editData.id}/`, {
                method: 'PUT',
                headers: {
    ...
    const confirmDeleteAssignment = async () => {
        ...
        try {
            const res = await fetch(`${(window.location.hostname === 'localhost' || window.location.hostname === '127.0.0.1' ? 'http://127.0.0.1:8000/api' : 'https://kravia.onrender.com/api')}/assignments/${deleteData.id}/`, {
                method: 'DELETE'
            });
            if (res.ok) {
    ...
    const handleGradeSubmission = async (e, submissionId) => {
        ...
        const formData = new FormData(e.target);
        try {
            const res = await fetch(`${(window.location.hostname === 'localhost' || window.location.hostname === '127.0.0.1' ? 'http://127.0.0.1:8000/api' : 'https://kravia.onrender.com/api')}/assignments/submissions/${submissionId}/grade/`, {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json',
                },
    ...
    const handleSubmitAssignment = async (e) => {
        ...
        const formData = new FormData(e.target);
        try {
            const res = await fetch(`${(window.location.hostname === 'localhost' || window.location.hostname === '127.0.0.1' ? 'http://127.0.0.1:8000/api' : 'https://kravia.onrender.com/api')}/assignments/${activeAssignment.id}/submissions/`, {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json',
                },
            ...
            if (res.ok) {
                ...
                try {
                    await fetch(`${(window.location.hostname === 'localhost' || window.location.hostname === '127.0.0.1' ? 'http://127.0.0.1:8000/api' : 'https://kravia.onrender.com/api')}/heatmap/log/`, {
                        method: 'POST',
                        headers: { 'Content-Type': 'application/json' },
